...
%\include{./incl/acronyms}



% \begin{acronyms}            
% 
% \acro{AU}{Aarhus University}
% \medbreak
% \acro{SDAM}{Social Dynamics in the Ancient Mediterranean}
% \medbreak
% \acro{}{} 
%\end{acronyms}              
...
% to change certain pages into landscape/portrait mode  (PRESENTATION OCTOBER)
